...
import com.example.im.controller.fragment.LostFragment;
...
public class MainActivity extends FragmentActivity {
    ...
    private RadioButton rb_main_lost;
    ...
    private void initListener() {
        ...
        //默认会话列表页面
        rg_main.check(R.id.rb_main_lost);
    }
    //实现fragment切换的方法
    ...
    private void initView() {
        ...
        rb_main_lost = findViewById(R.id.rb_main_lost);
        ...
        //定义底部标签图片大小和位置
        Drawable drawable_shouye = getResources().getDrawable(R.drawable.myself);
        //当这个图片被绘制时，给他绑定一个矩形 ltrb规定这个矩形
        drawable_shouye.setBounds(5, 13, 70, 80);
        //设置图片在文字的哪个方向
        rb_main_lost.setCompoundDrawables(null, drawable_shouye, null, null);
    }
}
